...
setlistener("/controls/engines/engine/throttle", func(n) {
  setprop("/controls/gear/brake-right", getprop("/controls/engines/engine/throttle"));
});

setlistener("/sim/signals/fdm-initialized", func {
    print("Steering system loaded.");
    settimer(update_steering, 2);
});

var update_steering = func {

    var aileron_steering="/sim/model/aileron-steering";
    var rudder_steering="/sim/model/rudder-steering";
    var both_steering="/sim/model/both-steering";
